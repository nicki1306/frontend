        ...
        <div>
            ...
            <footer className="bg-gray-800 text-white py-6 mt-10">
                <div className="container mx-auto text-center">
                    <p>&copy; {new Date().getFullYear()} Tienda de Juguetes. Todos los derechos reservados.</p>
                    <ul className="flex justify-center space-x-4 mt-4">
                        <li><a href="/about" className="hover:text-blue-400">Sobre Nosotros</a></li>
                        <li><a href="/privacy" className="hover:text-blue-400">Política de Privacidad</a></li>
                        <li><a href="/contact" className="hover:text-blue-400">Contáctanos</a></li>
                    </ul>
                </div>
            </footer>
        </div>
